...
syntax keyword liGbAsm contained cpl ld xor and or add sub sbc rr rl db ds call di ei halt nop jp jr ret reti cp inc dec push pop swap sla bit srl adc set res
